...
const MISSIONS=[
  ...
  {txt:'8️⃣ פרק ב׳: הגיעו לדלת המסגד הגדול 🕌',
   ...
   unlock:()=>{
     ...
     playScene('בלה: "מומו נחטפה! זיפו — רק אתה יכול להסתנן.\nקולין — חכה ליד הדלת הירוקה."');
   }},
  ...
  {txt:'1️⃣6️⃣ מצאו את כספת המסמכים — קומה ג׳ 🗂️',hint:'כספת — קומה ג׳',
   targetFn:()=>({x:0,z:-18}),
   unlock:()=>{
     playScene('שוקי: "הכספת בקומה השלישית. קוד — תאריך הקמת לוד."');
   }},
  // 17 — הכנעו את פלטו
  ...
  {txt:'2️⃣0️⃣ פרק ה׳: פגוש את רקס בכיכר הכדורים 🫡',
   ...
   targetFn:()=>({x:40,z:0}),
   unlock:()=>{
     showN('🌅 רקס מחכה לכם בכיכר הכדורים.');
   }},
  ...
  {txt:'2️⃣1️⃣ הכנע 6 כלבים מגיסות טיטאן 🐕⚔️  (הובסו: 0/6)',
   ...
   unlock:()=>{
     ...
     _spawnTitanScouts();
     showCut('new_threat',()=>{
       showN('⚠️ גיסות טיטאן — בריכת הנחת!');
     });
   }},
  ...
  {txt:'2️⃣2️⃣ הגיעו לבריכת הנחת — צפון הגשר 💧',
   ...
   unlock:()=>{
     playScene('רקס: "שם הוא מתכנן. נגיע לפניו."');
   }},
  // 23 — קרב טיטאן
  ...
  {txt:'2️⃣8️⃣ כנסו לבניין הנטוש 🔬',
   ...
   targetFn:()=>({x:25,z:-125}),
   unlock:()=>playScene('ריח חריף. דלת ברזל.\nמישהו עבד כאן זמן רב.')},

  // 29 — מציאת ההקלטה בפנים
  {txt:'2️⃣9️⃣ חפשו רמזים בתוך המעבדה 😱',
   hint:'בתוך המעבדה — שולחן ראשי',
   targetFn:()=>({x:25,z:-125}),
   unlock:()=>playScene('יש ציוד כאן. מישהו ניסה לשכפל משהו.\nחפשו את השולחן הראשי.')},
  ...
  {txt:'3️⃣2️⃣ הצתו את המקום 🔥',
   ...
   unlock:()=>{
     ...
     setTimeout(()=>{
       _showZippoLighter();
       playScene('זיפו הוציא את המצית שלו.\nקולין: "לכו. אני מסיים."\nזיפו: "לא. אני מסיים."');
     },600);
   }},
  ...
  {txt:'3️⃣6️⃣ היכנסו למרכז גהה 🏥',
   hint:'מרכז גהה — לוד',
   targetFn:()=>({x:62,z:-118}),
   unlock:()=>playScene('בית החולים לחולי נפש. נטוש 20 שנה.\nמשהו עדיין חי פה.')},
  ...
  {txt:'4️⃣1️⃣ עקבו אחרי העקבות — אזור תעשייה 🏭',
   ...
   targetFn:()=>({x:215,z:-90}),
   unlock:()=>{forceDog('momo','מומו מובילה — הריח שלה יוביל לתעשייה');playScene('מומו: "הריח מוביל לאזור התעשייה."');}},

  // 42 — חדירה למחסן
  {txt:'4️⃣2️⃣ חדרו למחסן הנטוש 📦',
   hint:'מחסן — אזור תעשייה',
   targetFn:()=>({x:205,z:-114}),
   unlock:()=>showN('🏭 מחסן APEX — כנס!')},
  ...
  {txt:'5️⃣4️⃣ עלו על הרכבת לתל אביב 🚆',
   ...
   targetFn:()=>({x:0,z:-150}),
   unlock:()=>playScene('הרכבת מגיעה. ריח הים כבר באוויר.')},
  ...
  {txt:'5️⃣6️⃣ בניין APEX — פינסקר 🏙️\nרק כניסה מהגג.',
   ...
   unlock:()=>{
     playScene('זיפו: "הדלת נעולה. יש כניסה מהגג."\nנירה: "יש מוצב APEX בדיזנגוף — זהרו."');
   }},
  ...
  {txt:'5️⃣7️⃣ טפסו לגג הבניין 🔬\nמשם נכנסים פנימה.',
   ...
   unlock:()=>playScene('קולין: "המדרגות מאחורי הבניין — שם הכניסה."')},
  ...
  {txt:'5️⃣9️⃣ לנמל תל אביב — מהר! ⚔️\nהם יודעים שאנחנו כאן.',
   ...
   unlock:()=>{
     ...
     playScene('קולין: "אני מוביל. תישארו קרובים!"');
   }},
  ...
  {txt:'🔜 האדריכל מחכה. פרק יֹ בקרוב.',
   hint:'תל אביב',
   targetFn:()=>G._taRabinPos||({x:0,z:-60}),
   unlock:()=>playScene('APEX עדיין שם.\nולמעלה ממנו — האדריכל.')},
];
