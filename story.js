...
const MISSIONS=[
  ...
  {txt:'2️⃣7️⃣ עקבו אחריו — הוא הלך לדרום ⚡',
   hint:'בניין נטוש — דרום לוד',
   targetFn:()=>({x:90,z:95}),
   unlock:()=>{}},

  // 28 — כניסה למעבדה (גילוי ראשוני)
  {txt:'2️⃣8️⃣ כנסו לבניין הנטוש 🔬',
   hint:'בניין ישן — דרום לוד (כנסו)',
   targetFn:()=>({x:90,z:95}),
  ...
  {txt:'3️⃣0️⃣ הצל ממתין בחוץ — הכנעו אותו ⚔️',
   hint:'הצל — ליד הבניין',
   targetFn:()=>G._shadowEnemy&&!G._shadowEnemy.dead?{x:G._shadowEnemy.x,z:G._shadowEnemy.z}:{x:92,z:90},
   unlock:()=>showN('⚔️ הצל מחכה. הוא חושב שהוא מגן על ביתו.')},

  // 31 — חוזרים לגלות "את השאר"
  {txt:'3️⃣1️⃣ חזרו למעבדה — יש עוד חדר 😱',
   hint:'בניין ישן — דרום לוד (כנסו שוב)',
   targetFn:()=>({x:90,z:95}),
