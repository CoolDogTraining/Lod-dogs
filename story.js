...
const MISSIONS=[
  ...
  {txt:'5️⃣4️⃣ לכו לשוק הכרמל 🥩\nמומו מריחה משהו.',
   hint:'שוק הכרמל — מערב העיר',
   targetFn:()=>G._taMarketPos||({x:-90,z:90}),
   unlock:()=>{
  ...
  {txt:'5️⃣6️⃣ בניין APEX — פינסקר 🏙️\nרק כניסה מהגג.',
   hint:'רחוב פינסקר — בניין האור הסגול',
   ...
   unlock:()=>{
     ...
     setTimeout(()=>{
       ...
       _spawnTAEnemy(ap.x-8,ap.z-10);
       _spawnTAEnemy(ap.x+8,ap.z-10);
       showN('⚠️ שומרים בכניסה!');
     },1500);
   }},

  // 57 — גג
  {txt:'5️⃣7️⃣ טפסו לגג הבניין 🔬\nמשם נכנסים פנימה.',
   hint:'מאחורי הבניין — כניסת גג',
   targetFn:()=>G._taLabRoofEntry||({x:70,z:-123}),
   unlock:()=>showN('🔍 קולין: "גג נקי. בואו נמצא פתח."')},
