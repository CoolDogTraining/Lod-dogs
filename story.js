...
const CUTS={
  ...
  ch6_shadow_zippo:{ch:'פרק ו׳ — צל',ti:'⚡ זיפו עוקב',tx:'זיפו עקב אחריו כל הדרך עד לבניין הישן בדרום.\n\nהצל נכנס. זיפו חיכה רגע — ונכנס אחריו.\nהצל עמד שם ולא הזיז שריר.\n\nזיפו ניגש.\n\nזיפו: "רקס?"\nהצל הסתובב לאט.\nהצל: "אני מכיר אותך."\nזיפו: "אתה מכיר אותי. נכון. אז בוא—"\nהצל: "אתה מהכנופייה ששמה אותו שם."\n\nזיפו הבין שמשהו לא בסדר.\n\nזיפו: "מי אמר לך את זה?"'},
...
const MISSIONS=[
  ...
  {txt:'3️⃣5️⃣ התקדמו לשפיה — בית החולים הנטוש ⚕️',
   hint:'שפיה — צפון לוד',
   targetFn:()=>({x:-20,z:-180}),
   unlock:()=>{
  ...
  {txt:'3️⃣8️⃣ הכנעו את Z-07 💀',
   ...
   targetFn:()=>G._z07Enemy&&!G._z07Enemy.dead?{x:G._z07Enemy.x,z:G._z07Enemy.z}:{x:-20,z:-210},
   unlock:()=>{
     setTimeout(()=>showCut('ch7_z07_intro',()=>{}),800);
   }},

  // 39 — פרק ח׳ (עתידי) — כ"ץ נמצא
  {txt:'🔜 פרק ח׳ — כ"ץ בחוץ. המשחק ממשיך...',
   hint:'לוד — חפשו את ד"ר כ"ץ',
   targetFn:()=>({x:0,z:60}),
   unlock:()=>{
     showN('🔜 פרק ח׳ יגיע בקרוב.\nכ"ץ עדיין בחוץ.');
   }},
];
